...
As strings are immutable, `foreach` internally converts any string to an array of characters via String.split(''), and sets the `this` scope to that string in its array form.
