...
As strings are immutable, `foreach` internally splits any string to an array of characters via `String.split('')`, and sets the `this` scope to be the string in array form. This allows for easy modification.
